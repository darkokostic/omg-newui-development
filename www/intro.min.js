...
(function(C, p) {
    ...
    function z() {
        ...
        if (this._introItems.length <=
            this._currentStep) "function" === typeof this._introCompleteCallback && this._introCompleteCallback.call(this), A.call(this, this._targetElement);
        else {
    ...
    function N(a) {
        ...
        if (null != c) {
            var e = d.querySelector(".introjs-helperNumberLayer"),
                g =
                d.querySelector(".introjs-tooltiptext"),
            ...
            if ((h = document.querySelectorAll(".introjs-fixParent")) && 0 < h.length)
                for (f = h.length - 1; 0 <= f; f--) h[f].className = h[f].className.replace(/introjs-fixParent/g, "").replace(/^\s+|\s+$/g, "");
            ...
            b._lastShowElementTimer = setTimeout(function() {
                null != e && (e.innerHTML = a.step, tutorialNum++);
                e.className = "introjs-helperNumberLayer tutorialNum"+ tutorialNum;
                g.innerHTML = a.intro;
            ...
            n.appendChild(w);
            n.appendChild(F);
            !0 == this._options.showStepNumbers && (h = document.createElement("span"), h.className = "introjs-helperNumberLayer tutorialNum"+ tutorialNum, h.innerHTML = a.step, l.appendChild(h));
            n.appendChild(c);
            l.appendChild(n);
    ...
    M.fn =
        p.prototype = {
            ...
            addHints: function() {
                a: {
                    var a =
                        this._targetElement;this._introItems = [];
                    ...
                    V.call(this);document.addEventListener ? (document.addEventListener("click", w.bind(this), !1), window.addEventListener("resize", K.bind(this), !0)) : document.attachEvent && (document.attachEvent("onclick",
            ...
            hideHints: function() {
                ...
                if (a && 0 < a.length)
                    for (var b = 0; b < a.length; b++) L.call(this, a[b].getAttribute("data-step"));
                return this
            }
        };
    return C.introJs = M
